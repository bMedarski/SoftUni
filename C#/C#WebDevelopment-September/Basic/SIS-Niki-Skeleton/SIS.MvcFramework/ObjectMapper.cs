...
namespace SIS.MvcFramework
{
	...
	public static class ObjectMapper
	{
		...
		public static object TryParse(string stringValue, Type type)
		{
			...
			switch (typeCode)
			{
				...
				case TypeCode.Object:
					if (IsEnumerableType(type) && stringValue != null &&stringValue.Contains("*$*"))
					{
						value = GetCollection(stringValue);
					}
					else
					{
						value = stringValue;
		...
		private static IEnumerable GetCollection(string stringValue)
		{
